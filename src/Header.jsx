  ...
  <li className="item">
    <div className="cart-item">
      ...
      <div className="cart-item-total">
        <p className="cart-item-quantity"><span className="span">QTD: {item.quantity}</span></p>
        <p className="cart-item-total-price"><span className="span">TOT: R${item.totalPrice.toFixed(2)}</span></p>
      </div>
    </div> 
  </li>
